...
func (c *lockServiceClient) CreateLock(ctx context.Context, in *CreateLockRequest, opts ...grpc.CallOption) (*CreateLockResponse, error) {
	...
	err := c.cc.Invoke(ctx, LockService_CreateLock_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedLockServiceServer) CreateLock(context.Context, *CreateLockRequest) (*CreateLockResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method CreateLock not implemented")
}
...
func (UnimplementedLockServiceServer) UpdateLock(context.Context, *UpdateLockRequest) (*UpdateLockResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method UpdateLock not implemented")
}
