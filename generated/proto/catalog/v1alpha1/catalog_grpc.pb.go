...
func (UnimplementedCatalogServiceServer) CreateUpdateCatalog(context.Context, *CreateUpdateCatalogRequest) (*CreateUpdateCatalogResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method CreateUpdateCatalog not implemented")
}
...
func (UnimplementedCatalogServiceServer) GetVersionCompliance(context.Context, *GetVersionComplianceRequest) (*GetVersionComplianceResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetVersionCompliance not implemented")
}
func (UnimplementedCatalogServiceServer) UpdateVersions(context.Context, *UpdateVersionsRequest) (*UpdateVersionsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method UpdateVersions not implemented")
}
func (UnimplementedCatalogServiceServer) UpdateDependencies(context.Context, *UpdateDependenciesRequest) (*UpdateDependenciesResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method UpdateDependencies not implemented")
}
