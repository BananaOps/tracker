...
|---|---|---|---|
| `--color-primary` | `#2563EB` | `#60A5FA` | Actions principales, sélection |
| `--color-primary-soft` | `#DBEAFE` | `#1E3A5F` | Fonds subtils, états actifs doux |
| `--color-impact-high` | `#F97316` | `#FB923C` | Impact fort, collision, priorité haute |
| `--color-impact-medium` | `#F59E0B` | `#FBBF24` | Vigilance |
| `--color-success` | `#22C55E` | `#4ADE80` | Statut nominal |
| `--color-bg` | `#F8FAFC` | `#0B1220` | Fond principal |
| `--color-surface` | `#FFFFFF` | `#111827` | Cartes, panneaux |
| `--color-surface-2` | `#F1F5F9` | `#1F2937` | Surfaces secondaires |
| `--color-border` | `#E2E8F0` | `#334155` | Bordures discrètes |
| `--color-text` | `#0F172A` | `#E5E7EB` | Texte principal |
| `--color-text-muted` | `#475569` | `#94A3B8` | Texte secondaire |
